...
function get_private_messages_section_header(): JQuery {
    return $(".direct-messages-container #direct_messages_section #direct_messages_section_header");
}
...
export function close(): void {
    ...
    $("#toggle_direct_messages_section_icon").removeClass("fa-caret-down");
    $("#toggle_direct_messages_section_icon").addClass("fa-caret-right");
...
export function expand(): void {
    ...
    $("#toggle_direct_messages_section_icon").addClass("fa-caret-down");
    $("#toggle_direct_messages_section_icon").removeClass("fa-caret-right");
    update_private_messages();
}
...
export function highlight_all_private_messages_view(): void {
    $(".direct-messages-container").addClass("active_direct_messages_section");
}

function unhighlight_all_private_messages_view(): void {
    $(".direct-messages-container").removeClass("active_direct_messages_section");
}

function scroll_pm_into_view($target_li: JQuery): void {
    const $container = $("#left_sidebar_scroll_container");
    const pm_header_height = $("#direct_messages_section_header").outerHeight();
