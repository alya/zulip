...
class TestGenerateDeactivationLink(BouncerTestCase):
    def test_generate_deactivation_link(self) -> None:
        ...
        self.assert_in_success_response(
            [
                "You are about to deactivate your Zulip server registration for server:",
                server.hostname,
        ...
        self.assert_in_success_response(["We have deactivated your server registration"], result)
